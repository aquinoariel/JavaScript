...
// Paso 1 - Crear un nuevo perro como instancia de la clase perro
const perro1 = new Perro ('Molo', 'Marron', 1)
const perro2 = new Perro ('Malena', 'Blanca', 25)
const perro3 = new Perro ('Argos', 'Negro', 20)
const perro4 = new Perro ('Pacha', 'Marron', 15)

// Paso 2 - Agregar perros a la lista
create(perro1)
create(perro2)
create(perro3)
create(perro4)

// Paso 3 - Busco un perro por su nombre - 
//console.log(findeOne('argos'))
